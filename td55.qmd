...
\begin{titlepage}
    \begin{center}
        ...
        {\Large \textbf{TD5 :Evaluation des modèles de prévision}}\\
        \vspace{0.5cm}
        ...
        {\large \textbf{CADET Thimothée, QUINTIN DE KERCADIO Pierre}}
...
data <- read_excel("/Users/pierrequintindekercadio/Documents/Documents - Mac/Serie temporelles/td5serie/wheat_support5_STU.xlsx")
...
rolling_forecast <- function(series, window_size, h = 1) {
  ...
  for (i in 1:(n - window_size - h + 1)) {
    ...
    # Vérifie qu'il n'y a pas de NA dans train
    if (any(is.na(train)) || sd(train) == 0) {
      next
    }
